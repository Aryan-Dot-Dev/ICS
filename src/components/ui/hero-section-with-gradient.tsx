    ...
    <div className="p-6 overflow-hidden rounded-xl">
      <div className="relative w-full">
        <div
          ...
          style={{
            backgroundImage: `
              radial-gradient(oklch(0.91 0.015 335) 1px, transparent 1px),
              linear-gradient(180deg, #faf6f8 0%, #f4e9ee 25%, #ecdae3 50%, #dfcad4 75%, #eedee6 90%, #faf6f8 100%)
            `,
        ...
        <div className="pt-4 pb-10 sm:pt-6 sm:pb-12 text-center">
          <div className="relative max-w-2xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-primary/10 border border-primary/20 rounded-full px-3.5 py-1.5 text-[9px] font-extrabold tracking-widest uppercase text-primary mb-6 animate-pulse select-none">
              <span className="w-1.5 h-1.5 bg-primary rounded-full" />
              Ruixen Platform Update: Version 3.4
            </div>
        ...
        >
          <div className="relative overflow-hidden px-2">
            ...
            <div className="inset-shadow-2xs max-h-[40vh] ring-background dark:inset-shadow-white/20 bg-background relative mx-auto max-w-5xl overflow-hidden rounded-t-2xl border border-gray-50 border-b-0 p-4 shadow-lg shadow-zinc-950/15 ring-1">
              <a href="https://ruixen.com?utm_source=21st.dev&utm_medium=hero_section_05&utm_campaign=ruixen" target="_blank" rel="noopener noreferrer">
                <img
                ...
                />
                <img
                  className="z-2 border-border/25 aspect-15/8 relative rounded-2xl dark:hidden w-full h-auto"

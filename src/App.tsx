...
export function App() {
  ...
  useEffect(() => {
    // If the user has completed the assessment form, or if the modal is currently visible, do not schedule
    if (hasSubmitted || isAssessmentOpen) return;
